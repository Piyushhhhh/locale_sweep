    ...
    sweepTest(
      ...
      builder: () => MaterialApp(
        ...
        theme: ThemeData(
          ...
          fontFamily: 'Roboto',
          fontFamilyFallback: const ['NotoNaskhArabic', 'NotoSansJP'],
        ),
...
const _t = {
  ...
  'de': {
    'title': 'LocaleSweep',
    'subtitle': 'Fehlerhafte Übersetzungen\nfinden, bevor Nutzer es tun',
    'checks': '6 Prüfungen',
    'ci': 'CI-fähig',
    'config': '0 Konfig',
    'missing': 'Fehlende Schlüssel',
    'missingDesc': 'Findet fehlende ARB-Schlüssel in Zielsprachen',
    'overflow': 'Überlauf-Erkennung',
    'overflowDesc': 'Erkennt defekte Layouts bei 2× Textgröße',
    'rtl': 'RTL-Prüfung',
    'rtlDesc': 'Spiegelt Layout für Arabisch & Hebräisch',
    'golden': 'Golden Screenshots',
  ...
  'ar': {
    'title': 'LocaleSweep',
    'subtitle': 'اكتشف الترجمات المعطلة\nقبل أن يكتشفها المستخدمون',
    'checks': '٦ فحوصات',
    'ci': 'CI جاهز',
    'config': 'RTL',
    'missing': 'مفاتيح مفقودة',
    'missingDesc': 'يكتشف مفاتيح ARB الغائبة',
    'overflow': 'كشف التجاوز',
    'overflowDesc': 'يلتقط التخطيطات المعطلة',
    'rtl': 'تحقق RTL',
    'rtlDesc': 'يعكس التخطيط للعربية والعبرية',
    'golden': 'لقطات ذهبية',
    'goldenDesc': 'إثبات بالبكسل لكل متغير',
    'cta': 'ابدأ الآن',
  ...
  'ja': {
    ...
    'config': '設定不要',
    'missing': '欠落キー検出',
    'missingDesc': '対象ロケールのARBキー欠落を検出',
    'overflow': 'オーバーフロー検出',
    'overflowDesc': '2倍テキストでレイアウト崩れを検出',
    'rtl': 'RTL検証',
    'rtlDesc': 'アラビア語・ヘブライ語のレイアウトを自動反転',
    'golden': 'ゴールデンスクリーンショット',
    'goldenDesc': '全バリアントのピクセルレベル検証',
    'cta': '始めましょう',
    'configuration': '設定',
  },
};
