...
abstract class AppLocalizations {
  ...
  /// No description provided for @settingsEmailDesc.
  ///
  /// In en, this message translates to:
  /// **'Receive daily digest at {time}'**
  String settingsEmailDesc(Object time);

  /// No description provided for @settingsPushLabel.
  ///
  /// In en, this message translates to:
  /// **'Push notifications'**
  String get settingsPushLabel;

  /// No description provided for @settingsPushDesc.
  ///
  /// In en, this message translates to:
  /// **'Get instant alerts for {category} updates'**
