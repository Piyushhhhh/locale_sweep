...
| Phone (393x852) | 2x Scale | Tablet (768x1024) |
|:---:|:---:|:---:|
| ![Onboarding EN](docs/screenshots/onboarding_en_393x852.png) | ![Onboarding 2x](docs/screenshots/onboarding_en_2.0x_393x852.png) | ![Onboarding Tablet](docs/screenshots/onboarding_en_768x1024.png) |
| ![Settings EN](docs/screenshots/settings_en_393x852.png) | ![Settings 2x](docs/screenshots/settings_en_2.0x_393x852.png) | ![Settings Tablet](docs/screenshots/settings_en_768x1024.png) |

*Generated by `sweepTest()` — actual golden screenshots from headless widget tests with real Roboto fonts and Material Icons.*
...
dev_dependencies:
  locale_sweep:
    git:
      url: https://github.com/Piyushhhhh/locale_sweep.git
```
